    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if "ACCESS_REFUSED" in str(e):
                ...
                logger.error(f"RabbitMQ authentication error: Check your username, password, and vhost configuration")
                logger.error(f"For CloudAMQP, make sure you're using the correct AMQP URL from your CloudAMQP instance dashboard")
            else:
    ...
    async def run_consumer(self) -> None:
        ...
        while self.running:
            try:
                ...
                logger.warning(f"RabbitMQ consumer error. Reconnecting in 5 seconds...")
